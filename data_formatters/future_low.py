...
class FutureLowFormatter(GenericDataFormatter):
    ...
    _column_definition = [
        ...
        ('future_1', DataTypes.REAL_VALUED, InputTypes.TARGET),
        ...
        ('open', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ('EMA_200', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ('STOCHk_5_3_3', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ('ADX_14', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),
        ('PSARls_0.02_0.2', DataTypes.REAL_VALUED, InputTypes.OBSERVED_INPUT),

        ('trade_date', DataTypes.DATE, InputTypes.KNOWN_INPUT),
    ...
    def split_data(self, df, valid_boundary=2020, test_boundary=2021):
        ...
        test = df.loc[(index >= test_boundary) & (df['date'] < '2021-06-01')]
